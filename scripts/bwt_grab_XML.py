...
# Revised February 2016 to write to SQL2014B* - Pat Landrum
# Revised database to include new San Ysidro PedWest ped-xing - Pat Landrum
# 
...
if __name__ == "__main__":
    ...
    conn = pyodbc.connect('DRIVER={SQL Server};SERVER=SQL2014B8;DATABASE=borderwaittimes;UID=bwt_app_rw;PWD=**********')
    cursor = conn.cursor()
    
    strSQL = "insert into dbo.border_wait_time_XML (time_captured, xml_doc) values ("
